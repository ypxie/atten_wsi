...
class InceptionFeat(nn.Module):
    def __init__(self, in_channels):
        super(InceptionFeat, self).__init__()
        self.branch1x1 = BasicConv2d(in_channels, 64, kernel_size=1)
        ...
        self.branch3x3dbl_3b = BasicConv2d(128, 64, kernel_size=(3, 1), padding=(1, 0))
    ...
    def forward(self, x):
        ...
        outputs = [branch1x1, branch3x3, branch3x3dbl, branch_pool] # 128*3
        return torch.cat(outputs, 1)

    # def __init__(self, in_channels, out_channels, hidden_channels=512):
    #     super(InceptionFeat, self).__init__()
    #     self.branch1 = BasicConv2d(in_channels, hidden_channels, kernel_size=1)
    #     self.branch2 = BasicConv2d(hidden_channels, out_channels, kernel_size=1)
